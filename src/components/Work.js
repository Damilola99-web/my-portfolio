		...
		<div name="work" className="w-full md:h-screen text-gray-300 bg-[#0a192f]">
			<div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
				...
				<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 rounded-lg">
					{/* card */}
					<div style={{backgroundImage: `url(${Todo})`}} className="group shadow-xl shadow-[#0a192f] container rounded-lg flex justify-center items-center mx-auto content-div">
						{/* hover effect  */}
						<div className='duration-300 scale-y-0 group-hover:scale-y-100 '>
							...
							<div className='pt-8 text-center'>
								<a href="https://todoapp-rasheed.vercel.app/">
									<button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-yellow-300 duration-300'>Demo</button>
								</a>
								<a href="https://github.com/Damilola99-web/todoapp">
									<button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-yellow-300 duration-300'>Code</button>
								</a>
							</div>
						</div>
					</div>
					{/* card */}
					<div style={{backgroundImage: `url(${Ecommerce})`}} className="group shadow-xl shadow-[#0a192f] container rounded-lg flex justify-center items-center mx-auto content-div">
						{/* hover effect  */}
						<div className='duration-300 scale-y-0 group-hover:scale-y-100'>
							<span className='text-xl font-bold text-white px-8 flex tracking-wider items-center justify-center text-center'>
					...
					{/* card */}
					<div style={{backgroundImage: `url(${Country})`}} className="group shadow-xl shadow-[#0a192f] container rounded-lg flex justify-center items-center mx-auto content-div">
						{/* hover effect  */}
						<div className='duration-300 scale-y-0 group-hover:scale-y-100'>
							<span className='text-xl font-bold text-white px-8 flex tracking-wider items-center justify-center text-center'>
