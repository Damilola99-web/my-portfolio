  ...
  return (
    <div name='home' className='bg-[#0a192f] h-screen w-full'>
      ...
      <div className='max-w-[1000px] mx-auto p-8 flex flex-col justify-center h-full lg:px-[70px]'>
          ...
          <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a Front-End Developer specializing in building exceptional digital experiences. Currently, I'm focused on building responsive and dynamic web application</p>
          <div>
              <button className='text-white group border-2 px-6 py-3 flex items-center my-2 hover:bg-pink-600 duration-300'>View Work 
