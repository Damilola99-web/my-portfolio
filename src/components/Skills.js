	...
	return (
		<div name="skills" className="w-full h-full bg-[#0a192f] text-gray-300">
			...
			<div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
				<div>
					<p data-aos='fade-down' className=" text-3xl font-bold inline border-b-4 border-pink-600">Skills</p>
					<p className="py-4" data-aos = 'fade-up' >// These are the technologies I've worked with.</p>
				</div>
				{/* container for skills */}
				<div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 py-8">
					<div data-aos = 'flip-left' className="flex flex-col pt-4 items-center justify-center shadow-md shadow-[#040c16] hover:scale-110 duration-500">
