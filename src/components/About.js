		...
		<div name="about" className="w-full h-[98vh] bg-[#0a192f] text-gray-300">
			<div className="flex flex-col justify-center items-center w-full h-full px-8 sm:px-20">
				...
				<div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8">
					<div>
						<p data-aos ='fade-right' className="sm:text-right text-3xl font-bold">
							Hi, I'm Abdul-Rasheed, nice to meet you. Please take a look around.
						</p>
					</div>
					<div>
						...
						<a href={Myresume}>
							<button data-aos='fade-up' className="text-white group mt-6 border-2 px-6 py-3 flex items-center my-2 hover:bg-pink-600 duration-300">
								Download Resume
